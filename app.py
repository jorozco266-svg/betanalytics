...
LIGAS = {
    "ðŸŸï¸ La Liga":            {"src":"fd","code":"PD",  "avg":1.35, "odds_key":"soccer_spain_la_liga"},
    "ðŸ´ Premier League":    {"src":"fd","code":"PL",  "avg":1.40, "odds_key":"soccer_epl"},
    "ðŸŸï¸ Bundesliga":          {"src":"fd","code":"BL1", "avg":1.55, "odds_key":"soccer_germany_bundesliga"},
    "ðŸŸï¸ Serie A":             {"src":"fd","code":"SA",  "avg":1.30, "odds_key":"soccer_italy_serie_a"},
    "ðŸŸï¸ Ligue 1":             {"src":"fd","code":"FL1", "avg":1.35, "odds_key":"soccer_france_ligue_one"},
    "ðŸŸï¸ Primeira Liga":       {"src":"fd","code":"PPL", "avg":1.30, "odds_key":None},
    "ðŸ† Champions League":     {"src":"fd","code":"CL",  "avg":1.45, "odds_key":"soccer_uefa_champs_league"},
    "ðŸ† Europa League":        {"src":"wiki","wiki_url":"https://es.wikipedia.org/wiki/Liga_Europa_de_la_UEFA_2025-26", "wiki_fmt":"conmebol", "avg":1.35, "odds_key":"soccer_uefa_europa_league"},
    "âš½ Liga BetPlay":        {"src":"wiki","wiki_url":"https://es.wikipedia.org/wiki/Torneo_Apertura_2026_(Colombia)",       "wiki_fmt":"betplay",  "avg":1.20, "odds_key":None,
    ...
    "âš½ Torneo BetPlay B":    {"src":"wiki","wiki_url":"https://es.wikipedia.org/wiki/Categor%C3%ADa_Primera_B_2026",            "wiki_fmt":"betplay",  "avg":1.10, "odds_key":None},
    ...
    "âš½ Liga Argentina":      {"src":"wiki","wiki_url":"https://es.wikipedia.org/wiki/Torneo_Clausura_2026_(Argentina)",         "wiki_fmt":"betplay",  "avg":1.30, "odds_key":"soccer_argentina_primera_division"},
    "âš½ Brasileirao":         {"src":"wiki","wiki_url":"https://es.wikipedia.org/wiki/Campeonato_Brasileiro_S%C3%A9rie_A_2026",  "wiki_fmt":"betplay",  "avg":1.35, "odds_key":"soccer_brazil_campeonato"},
    "âš½ Liga MX":             {"src":"wiki","wiki_url":"https://es.wikipedia.org/wiki/Torneo_Clausura_2026_(M%C3%A9xico)",       "wiki_fmt":"betplay",  "avg":1.25, "odds_key":"soccer_mexico_ligamx"},
}
